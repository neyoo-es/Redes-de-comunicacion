...
public class NFDirectoryServer {
	...
	private void sendResponseTestMode(DatagramPacket pkt) throws IOException {
		...
		//Primer TO DO construimos el string a partir de pkt
	...
	private void sendResponse(DatagramPacket pkt) throws IOException {
		...
		case DirMessageOps.OPERATION_REGISTER_SERVER: {
			...
			msgToSend = new DirMessage(DirMessageOps.OPERATION_REGISTER_OK, assignedNick);
			System.out.println("[sendResponse] REGISTER nick='" + assignedNick + "' addr=" + serverAddr);
			break;
		}

		case DirMessageOps.OPERATION_GET_PEER_LIST: {
			msgToSend = new DirMessage(DirMessageOps.OPERATION_PEER_LIST);
